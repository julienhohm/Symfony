...
class LoadDepartment implements FixtureInterface, OrderedFixtureInterface
{
	public function load(ObjectManager $manager)
	{
		...
		foreach($departments as $dep)
		{
			...
			$department->setRegion($manager->getRepository("JHTourismeBundle:Region")->find($dep["region"]));
